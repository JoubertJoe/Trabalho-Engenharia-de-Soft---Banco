...
public class CadastroFuncionario extends JFrame {
	...
	public void criaComponentes() {
		...
		txtNomefuncionario.setBounds(88, 39, 394, 20);
		contentPane.add(txtNomefuncionario);
		txtNomefuncionario.setColumns(45);
		...
		comboEstadoCivil.setModel(new DefaultComboBoxModel(new String[] {"SOLTEIRO", "CASADO", "DIVORCIADO", "VIUVO", "UNI\u00C3O EST\u00C1VEL", "AMAZIADO"}));
		comboEstadoCivil.setFont(new Font("Arial Black", Font.PLAIN, 11));
		comboEstadoCivil.setBounds(120, 98, 152, 20);
		contentPane.add(comboEstadoCivil);
		...
		comboEstado.setBounds(413, 191, 69, 20);
		...
		lblCargo.setFont(new Font("Arial Black", Font.PLAIN, 11));
		lblCargo.setBounds(224, 219, 83, 14);
		contentPane.add(lblCargo);
		
		JComboBox comboCargo = new JComboBox();
		comboCargo.setModel(new DefaultComboBoxModel(new String[] {"Atendente", "Ajudante", "Caixa", "Seguran\u00E7a"}));
