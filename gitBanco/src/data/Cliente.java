...
public class Cliente {
	...
	private String nome, cpf, rg, datanascimento, sexo, estadocivil, endereco, numero, complemento, cep, bairro, cidade,
			estado, ddd, telefone, celular, email;
	private int index;

	public Cliente(String pnome, String pcpf, String prg, String pdatanascimento, String psexo, String pestadocivil,
			String pendereco, String pnumero, String pcomplemento, String pcep, String pbairro, String pcidade,
			String pestado, String pddd, String ptelefone, String pcelular, String pemail, int pindex) {
